...
def get_players(game_n: int) -> List[PlayerController]:
    ...
    heuristic2: Heuristic = SimpleHeuristic(game_n) #this should probably be something else idk what
    ...
    players: List[PlayerController] = [human1, computer1]
    #players: List[PlayerController] = [human1, human2] #human2 is no longer playing
